...
{{-- <div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                <div class="card-title mb-3">Journal No - <strong>{{ $journal->code }}</strong></div>
                ...
                <form action="{{ route('journal-detail.store') }}" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-8 mb-3">
                            ...
                            <select name="serial_number" id="serial_number" class="form-control select-single">
            ...
            <div class="modal-body">
                <form action="{{ route('journal-detail.store') }}" method="post">
                    ...
                    <input type="hidden" name="journals_id" value="{{ $journal->id }}">
                        ...
                        <div class="form-group">
                            <label for="serial_number">Serial Number</label>
                            <select name="serial_number" id="serial_number" class="form-control select-single @error('serial_number') is-invalid @enderror" style="width: 100%">
                                <option value="-">-Select-</option>
                            </select>
                            @error('serial_number')
                            <span class="text-danger">{{ $message }}</span>
